...
:ref:`s-config-files`). This is important since we want to give the
...
package maintainer scripts. See :ref:`s-config-files` for more
details.
...
should place a file named as specified in :ref:`s-cron-files` into
