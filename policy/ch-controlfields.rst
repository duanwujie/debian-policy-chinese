...
See :ref:`s-maintainer` for additional requirements and information
about package maintainers.
...
-  An architecture wildcard identifying a set of Debian machine
   architectures, see :ref:`s-arch-wildcard-spec`. ``any`` matches
...
See :ref:`s-debianrules` for information on how to get the
...
Their syntax and semantics are described in :doc:`??? <ch-relationships>`.
...
See :ref:`s-descriptions` for further information on this.
